<h1 align="center">Goldfinch NFT</h1>

<p align="center">Bot for mint NFT Goldfinch on the <a href="https://www.mygateway.xyz/dao/goldfinch">Mygateway.xyz</a></p>
<p align="center">
...
**Successfully registered accounts are saved in** ```registered.txt``` **in the format** ```{address}:{privare_key}:{email}```
